...
final class EnabledKnowledgeBaseSectionTest extends AbstractTestCase
{
    public static function dataArrayProvider(): iterable
    {
        yield 'enable knowledge base section' => [
            'sectionId' => 10,
            'response' => [
                'kb_section' => [
                    'section_id' => 10,
    ...
    {
        $url = $this->host."/api/kb_section/$sectionId/enable.json";

        Http::fake([
            $url => Http::response($response),
        ]);

        $responseData = $this->makeHttpClient()->knowledgeBase()->enableSection($sectionId);
