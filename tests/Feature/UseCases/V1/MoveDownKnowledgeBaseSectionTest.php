...
final class MoveDownKnowledgeBaseSectionTest extends AbstractTestCase
{
    public static function dataArrayProvider(): iterable
    {
        yield 'move down knowledge base section' => [
            'sectionId' => 10,
            'response' => [
                'kb_section' => [
                    'section_id' => 10,
    ...
    {
        $url = $this->host."/api/kb_section/$sectionId/movedown.json";
        ...
        $this->assertEquals(MoveDownKnowledgeBaseSectionResponse::from($response), $responseData);
    }
}
