...
final class EnableKnowledgeBaseArticleTest extends AbstractTestCase
{
    ...
    public function testHttp(int $articleId, array $response): void
    {
        ...
        $payload = new EnableArticlePayload($articleId);
        $responseData = $this->makeHttpClient()->knowledgeBase()->enableArticle($payload);
        ...
        $this->assertEquals(EnableKnowledgeBaseArticleResponse::from($response), $responseData);
    }
}
