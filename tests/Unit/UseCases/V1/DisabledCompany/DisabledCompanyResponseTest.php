...
namespace Palach\Omnidesk\Tests\Unit\UseCases\V1\DisabledCompany;
...
final class DisabledCompanyResponseTest extends AbstractTestCase
{
    public static function dataProvider(): iterable
    {
        yield 'disable company response' => [
            ...
            'expected' => new DisabledCompanyResponse(
    ...
    public function testFromArray(array $data, DisabledCompanyResponse $expected): void
    {
        $actual = DisabledCompanyResponse::validateAndCreate($data);
