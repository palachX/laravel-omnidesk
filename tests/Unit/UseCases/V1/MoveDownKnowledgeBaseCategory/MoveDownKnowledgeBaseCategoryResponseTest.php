...
final class MoveDownKnowledgeBaseCategoryResponseTest extends AbstractTestCase
{
    public static function dataArrayProvider(): iterable
    {
        yield 'move down knowledge base category response' => [
            'data' => [
                'kb_category' => [
                    'category_id' => 234,
    ...
    {
        $response = MoveDownKnowledgeBaseCategoryResponse::from($data);
