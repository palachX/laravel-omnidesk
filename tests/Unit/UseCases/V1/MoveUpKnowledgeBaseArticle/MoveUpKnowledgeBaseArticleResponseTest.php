...
final class MoveUpKnowledgeBaseArticleResponseTest extends AbstractTestCase
{
    public static function dataArrayProvider(): iterable
    {
        yield 'move up knowledge base article response' => [
            'data' => [
                'kb_article' => [
                    'article_id' => 100,
                    'section_id' => 20,
    ...
    {
        $response = MoveUpKnowledgeBaseArticleResponse::from($data);
