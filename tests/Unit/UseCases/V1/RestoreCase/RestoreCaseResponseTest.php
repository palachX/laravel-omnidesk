...
final class RestoreCaseResponseTest extends AbstractTestCase
{
    public static function dataProvider(): iterable
    {
        yield 'complete case data' => [
            ...
            'expected' => new RestoreCaseResponse(
                case: new CaseData(
                    caseId: 2000,
    ...
    public function testFromArray(array $data, RestoreCaseResponse $expected): void
    {
        $actual = RestoreCaseResponse::from($data);
