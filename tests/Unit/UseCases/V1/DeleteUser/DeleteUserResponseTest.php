...
final class DeleteUserResponseTest extends AbstractTestCase
{
    public static function dataProvider(): iterable
    {
        yield 'delete user response' => [
            'data' => [
                'user' => [
                    'user_id' => 200,
            ...
            'expected' => new DeleteUserResponse(
                user: new UserData(
                    userId: 200,
    ...
    public function testFromArray(array $data, DeleteUserResponse $expected): void
    {
        $actual = DeleteUserResponse::validateAndCreate($data);
