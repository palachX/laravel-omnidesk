...
final class MoveUpKnowledgeBaseSectionResponseTest extends AbstractTestCase
{
    public static function dataArrayProvider(): iterable
    {
        yield 'move up knowledge base section response' => [
            'data' => [
                'kb_section' => [
                    'section_id' => 10,
                    'category_id' => 2,
    ...
    {
        $response = MoveUpKnowledgeBaseSectionResponse::from($data);
