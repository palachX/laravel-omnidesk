...
final class DeleteCompanyResponseTest extends AbstractTestCase
{
    public static function dataProvider(): iterable
    {
        yield 'delete company response' => [
            'data' => [
                'company' => [
                    'company_id' => 200,
            ...
            'expected' => new DeleteCompanyResponse(
    ...
    public function testFromArray(array $data, DeleteCompanyResponse $expected): void
    {
        $actual = DeleteCompanyResponse::validateAndCreate($data);
